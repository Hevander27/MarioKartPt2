...
class ViewController: UIViewController,
  ...
  @IBAction func didTapMushroom(_ sender: UITapGestureRecognizer) {
    ...
    // to a variable. Print something if it's not nil
      ...
      // ==================================================================================
      // CRITICAL: FORCE-UNWRAPPING AN OPTIONAL VALUE THAT CONTAINS NIL WILL CRASH THE APP.
      // ==================================================================================
      guard let powerup = MushroomGenerator.maybeGenerateMushroomPowerup() else {
          print("Didn't get a power up")
          return
      }
  ...
  // Exercise 3: Decipher the mystery box and apply the correct effect on mariox
    // =====================================================================================
    //  TYPE CASTING, a way to check or treat if a value can be treated as a different type.
    // =====================================================================================
  private func decipher(mysteryBox: MysteryBox) {
      // print(mysteryBox.mysteryEffect)
      // using guard, NOT using as! force casting
      guard let effectDictionary = mysteryBox.mysteryEffect as? [String: String] else {
          assertionFailure("Expecting value of type dirctionary")
          return
      }
      ...
      // Apply the correc teffect to Mario
      if effect == "translate" {
          print("translate")
  ...
  func applyNumKartsSetting(_ settings: [String : Any]) {
    ...
    // unhide the correct number ofn karts
